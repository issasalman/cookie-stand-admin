            ...
            <form className=" bg-emerald-300 mt-8 p-4 w-2/3 mx-auto items-center rounded-md"  onSubmit={props.cookiestand}>
                ...
                <div className='flex'>
                    ...
                    <div className='flex w-full space-x-3'>
                        <div className='flex flex-col p-2 rounded bg-emerald-100'>
                            <label className="  font-semibold"  >Average Cookie per Sale</label>
                            <input type="number" className="" name="avg" />
                        </div>

                        <div className='flex flex-col p-2 pb-2 rounded bg-emerald-100'>
                        ...
                        <button className=" px-28 mx-30 py-2  bg-emerald-500 rounded-md font-semibold text-gray-900">Create</button>
